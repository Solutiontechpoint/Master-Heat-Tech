...
FOOTER_BLOCK_HTML = """
                                    <li class="nav-main-item isotope-filter menu-item menu-item-type-custom menu-item-object-custom menu-item-1551"> <a class="nav-main-link" href="../../master-heat-tech-products/index.html#filter=.coil-heaters" title="Coil Heaters Master Heat Industries">Coil Heaters</a></li>
